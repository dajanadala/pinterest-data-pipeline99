...
def run_infinite_post_data_loop():
    while True:
        ...
        with engine.connect() as connection:
            ...
            invoke_url1 = "https://9cffizextl.execute-api.us-east-1.amazonaws.com/production/streams/streaming-0e2b04098249-pin/record"
       ...
       "save_location": pin_result["save_location"], "category": pin_result["category"]
            ...
            invoke_url2 = "https://9cffizextl.execute-api.us-east-1.amazonaws.com/production/streams/streaming-0e2b04098249-geo/record"

            #To send JSON messages
            payload2 = json.dumps({
                "StreamName": "streaming-0e2b04098249-geo",
                "Data": {
                        #Data should be send as pairs of column_name:value, with different columns separated by commas      
            ...
            invoke_url3 = "https://9cffizextl.execute-api.us-east-1.amazonaws.com/production/streams/streaming-0e2b04098249-user/record"
            
            #To send JSON messages
            payload3 = json.dumps({
                "StreamName": "streaming-0e2b04098249-user",
                "Data": {
                        #Data should be send as pairs of column_name:value, with different columns separated by commas      
